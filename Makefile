# Database - Generic, reusable Go module for relational database operations.
...
challenge:
	../challenges/scripts/database_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "Database - Generic, reusable Go module for relational database operations."
	@echo ""
	@echo "Build & Test:"
